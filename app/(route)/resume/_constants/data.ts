      ...
      projects: [
        {
          ...
          period: "2024.08 - 현재",
          description:
            "AWS, Azure, GCP, OCI SDK를 활용하여 통합 멀티 클라우드 관리 서비스 입니다. 여러 클라우드의 리소스를 단일 인터페이스에서 모니터링하고 제어할 수 있는 시스템을 개발했으며, VM 관리와 대시보드, 모니터링 기능 등 전반적인 CSP 서비스들을 담당하여 구현했습니다. 이때 클라우드에 대한 지식이 크게 늘었습니다.",
          contributions: [
