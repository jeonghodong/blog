export const resumeData = {
  ...
  header: {
    ...
    description: "고객 문제를 정의하고, 기술로 해결하고, 제품을 성장시킵니다.\n프론트, 백엔드, 기획 경계를 두지 않으려 해요.\n필요한 곳이면 어디든 뛰어듭니다. 기술 스택보다 제품의 성장이 곧 저의 성장이라 생각합니다.",
  },
  // 경력
  experiences: [
    {
      ...
      projects: [
        {
          ...
          techStack: ["TypeScript", "Commander.js", "AWS SDK v3", "Zod"],
        },
      ],
    },
    {
      ...
      projects: [
        {
          ...
          techStack: ["TypeScript", "Next.js", "TailwindCSS", "Framer Motion", "Zustand", "Firebase", "Kakao SDK", "AWS (S3 / CloudFront)"],
        },
      ],
    },
    {
