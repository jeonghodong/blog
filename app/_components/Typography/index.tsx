...
const variants: Record<VariantKey, string> = {
  "headline.100": "text-[42px] font-bold tracking-[-0.5px]",
  "headline.200": "text-[36px] font-semibold tracking-[-0.5px]",
  "headline.300": "text-[32px] font-semibold tracking-[-0.5px]",
  "headline.400": "text-[28px] font-semibold tracking-[-0.5px]",
  "title.100": "text-2xl font-normal tracking-[-0.5px]",
  "title.101": "text-2xl font-normal tracking-[-0.5px]",
  "title.100_sb": "text-2xl font-semibold tracking-[-0.5px]",
  "title.200": "text-[22px] font-normal tracking-[-0.5px]",
  "title.200_sb": "text-[22px] font-semibold tracking-[-0.5px]",
  ...
  "body.100": "text-base font-normal tracking-[-0.5px]",
  "body.100_sb": "text-base font-semibold tracking-[-0.5px]",
  "body.200": "text-[15px] font-normal tracking-[-0.5px]",
  "body.200_sb": "text-[15px] font-semibold tracking-[-0.5px]",
  "body.201": "text-[15px] font-normal tracking-[-0.5px]",
  "body.300": "text-sm font-normal tracking-[-0.5px]",
  "body.300_sb": "text-sm font-semibold tracking-[-0.5px]",
  "body.301": "text-sm font-normal tracking-[-0.5px]",
  "caption.100": "text-[13px] font-normal tracking-[-0.5px]",
  "caption.100_sb": "text-[13px] font-semibold tracking-[-0.5px]",
  "caption.200": "text-xs font-normal tracking-[-0.5px]",
  "caption.200_sb": "text-xs font-semibold tracking-[-0.5px]",
  "caption.300": "text-[11px] font-normal tracking-[-0.5px]",
  "caption.300_sb": "text-[11px] font-semibold tracking-[-0.5px]",
  gnb_on: "text-xs font-bold",
  gnb_off: "text-xs font-normal tracking-[-0.5px]",
...
const Typography: React.FC<TypographyProps> = ({ variant, children, className, color }) => {
  ...
  return <Element className={classNames(variants[variant], lineHeights[variant], colorClass, className)}>{typeof children === "string" ? <span>{children}</span> : children}</Element>;
};
